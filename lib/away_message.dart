...
class AwayMsg extends StatefulWidget {
  const AwayMsg({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<AwayMsg> createState() => state();
}

class state extends State<AwayMsg> {
  @override
